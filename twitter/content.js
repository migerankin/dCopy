class TwitterImageHandler {
    ...
    // interceptBackButton() {
    //     const tryIntercept = () => {
    //         const button = document.querySelector('button[data-testid="app-bar-back"]');
    //         if (!button) return;

    //         const parentDiv = button.closest('div');
    //         if (!parentDiv) return;

    //         // 禁用 button 的交互，让点击事件穿透
    //         button.style.pointerEvents = 'none';
    //         button.style.background = 'transparent';

    //         if (!parentDiv.dataset.hasJumpHandler) {
    ...
    //             parentDiv.dataset.hasJumpHandler = 'true';
    //         }
    //     };
